  ...
  return <div>
    ...
    <Card>
      ...
      <div style={{ marginTop: 16, padding: "14px 18px", background: C.accentSoft, borderRadius: 12, fontSize: F.small, color: C.textMid, lineHeight: 1.5 }}>
        BankStaff+ licence at this size: <strong style={{ color: C.accent }}>{fmt(platformCostFor(bankPool))}/yr</strong> <span style={{ color: C.textMuted }}>(ex VAT, banded by the number of workers on your bank register; your return is measured against this fee)</span>
      </div>
